...
"</body></html>", nullptr));
...
#if QT_CONFIG(tooltip)
        deleteToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Remove this graph.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        copyToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Duplicate this graph.", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        todCheckBox->setText(QCoreApplication::translate("IOGraphDialog", "Time of day", nullptr));
        logCheckBox->setText(QCoreApplication::translate("IOGraphDialog", "Log scale", nullptr));
        resetButton->setText(QCoreApplication::translate("IOGraphDialog", "Reset", nullptr));
    } // retranslateUi
