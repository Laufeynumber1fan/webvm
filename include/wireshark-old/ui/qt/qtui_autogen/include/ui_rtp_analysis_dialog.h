...
public:
    ...
    void retranslateUi(QDialog *RtpAnalysisDialog)
    {
        ...
        actionSaveAudioUnsync->setText(QCoreApplication::translate("RtpAnalysisDialog", "Unsynchronized Forward and Reverse Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveAudioUnsync->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the unsynchronized audio data for both channels.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveForwardAudioUnsync->setText(QCoreApplication::translate("RtpAnalysisDialog", "Unsynchronized Forward Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveForwardAudioUnsync->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the unsynchronized forward stream audio data.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveReverseAudioUnsync->setText(QCoreApplication::translate("RtpAnalysisDialog", "Unsynchronized Reverse Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveReverseAudioUnsync->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the unsynchronized reverse stream audio data.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveCsv->setText(QCoreApplication::translate("RtpAnalysisDialog", "CSV", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveCsv->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save both tables as CSV.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveForwardCsv->setText(QCoreApplication::translate("RtpAnalysisDialog", "Forward Stream CSV", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveForwardCsv->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the forward table as CSV.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveReverseCsv->setText(QCoreApplication::translate("RtpAnalysisDialog", "Reverse Stream CSV", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveReverseCsv->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the reverse table as CSV.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
        actionSaveAudioSyncStream->setText(QCoreApplication::translate("RtpAnalysisDialog", "Stream Synchronized Forward and Reverse Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveAudioSyncStream->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the audio data for both channels synchronized to start of earlier stream.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveForwardAudioSyncStream->setText(QCoreApplication::translate("RtpAnalysisDialog", "Stream Synchronized Forward Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveForwardAudioSyncStream->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the forward stream audio data synchronized to start of earlier stream.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveReverseAudioSyncStream->setText(QCoreApplication::translate("RtpAnalysisDialog", "Stream Synchronized Reverse Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveReverseAudioSyncStream->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the reverse stream audio data synchronized to start of earlier stream.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveAudioSyncFile->setText(QCoreApplication::translate("RtpAnalysisDialog", "File Synchronized Forward and Reverse Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveAudioSyncFile->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the audio data for both channels synchronized to start of file.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveForwardAudioSyncFile->setText(QCoreApplication::translate("RtpAnalysisDialog", "File Synchronized Forward Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveForwardAudioSyncFile->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the forward stream audio data synchronized to start of file.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionSaveReverseAudioSyncFile->setText(QCoreApplication::translate("RtpAnalysisDialog", "File Synchronized Reverse Stream Audio", nullptr));
#if QT_CONFIG(tooltip)
        actionSaveReverseAudioSyncFile->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "Save the reverse stream audio data synchronized to start of file.", nullptr));
#endif // QT_CONFIG(tooltip)
        statisticsLabel->setText(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p><span style=\" font-size:medium; font-weight:600;\">Forward</span></p><p><span style=\" font-size:medium; font-weight:600;\">Reverse</span></p></body></html>", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = forwardTreeWidget->headerItem();
        ___qtreewidgetitem->setText(7, QCoreApplication::translate("RtpAnalysisDialog", "Status", nullptr));
        ___qtreewidgetitem->setText(6, QCoreApplication::translate("RtpAnalysisDialog", "Marker", nullptr));
        ___qtreewidgetitem->setText(5, QCoreApplication::translate("RtpAnalysisDialog", "Bandwidth", nullptr));
        ___qtreewidgetitem->setText(4, QCoreApplication::translate("RtpAnalysisDialog", "Skew", nullptr));
        ___qtreewidgetitem->setText(3, QCoreApplication::translate("RtpAnalysisDialog", "Jitter (ms)", nullptr));
        ___qtreewidgetitem->setText(2, QCoreApplication::translate("RtpAnalysisDialog", "Delta (ms)", nullptr));
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("RtpAnalysisDialog", "Sequence", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("RtpAnalysisDialog", "Packet", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(forwardTreeWidget), QCoreApplication::translate("RtpAnalysisDialog", "Forward", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(reverseTreeWidget), QCoreApplication::translate("RtpAnalysisDialog", "Reverse", nullptr));
#if QT_CONFIG(tooltip)
        fJitterCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward jitter values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        fJitterCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Forward Jitter", nullptr));
#if QT_CONFIG(tooltip)
        fDiffCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward difference values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        fDiffCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Forward Difference", nullptr));
#if QT_CONFIG(tooltip)
        fDeltaCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide forward delta values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        fDeltaCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Forward Delta", nullptr));
#if QT_CONFIG(tooltip)
        rJitterCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse jitter values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        rJitterCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Reverse Jitter", nullptr));
#if QT_CONFIG(tooltip)
        rDiffCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse difference values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        rDiffCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Reverse Difference", nullptr));
#if QT_CONFIG(tooltip)
        rDeltaCheckBox->setToolTip(QCoreApplication::translate("RtpAnalysisDialog", "<html><head/><body><p>Show or hide reverse delta values.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        rDeltaCheckBox->setText(QCoreApplication::translate("RtpAnalysisDialog", "Reverse Delta", nullptr));
