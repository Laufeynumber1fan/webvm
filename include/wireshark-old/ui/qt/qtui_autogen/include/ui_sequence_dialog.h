...
"</body></"
        ...
        addressComboBox->setItemText(0, QCoreApplication::translate("SequenceDialog", "Any", nullptr));
        addressComboBox->setItemText(1, QCoreApplication::translate("SequenceDialog", "Network", nullptr));

        resetButton->setText(QCoreApplication::translate("SequenceDialog", "Reset", nullptr));
        (void)SequenceDialog;
    } // retranslateUi
