...
public:
    ...
    void retranslateUi(QDialog *VoipCallsDialog)
    {
        ...
        actionSelect_All->setText(QCoreApplication::translate("VoipCallsDialog", "Select &All", nullptr));
#if QT_CONFIG(tooltip)
        actionSelect_All->setToolTip(QCoreApplication::translate("VoipCallsDialog", "Select all calls", nullptr));
#endif // QT_CONFIG(tooltip)
        actionCopyAsCsv->setText(QCoreApplication::translate("VoipCallsDialog", "Copy as CSV", nullptr));
#if QT_CONFIG(tooltip)
        actionCopyAsCsv->setToolTip(QCoreApplication::translate("VoipCallsDialog", "Copy stream list as CSV.", nullptr));
#endif // QT_CONFIG(tooltip)
        actionCopyAsYaml->setText(QCoreApplication::translate("VoipCallsDialog", "Copy as YAML", nullptr));
#if QT_CONFIG(tooltip)
        actionCopyAsYaml->setToolTip(QCoreApplication::translate("VoipCallsDialog", "Copy stream list as YAML.", nullptr));
#endif // QT_CONFIG(tooltip)
