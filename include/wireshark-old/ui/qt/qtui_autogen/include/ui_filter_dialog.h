...
public:
    ...
    void retranslateUi(QDialog *FilterDialog)
    {
        ...
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("FilterDialog", "Filter", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("FilterDialog", "Name", nullptr));
