...
public:
    ...
    void retranslateUi(QDialog *ProfileDialog)
    {
        ...
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("ProfileDialog", "Name", nullptr));
...
#if QT_CONFIG(tooltip)
        deleteToolButton->setToolTip(QCoreApplication::translate("ProfileDialog", "Remove this profile. System provided profiles cannot be removed.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
