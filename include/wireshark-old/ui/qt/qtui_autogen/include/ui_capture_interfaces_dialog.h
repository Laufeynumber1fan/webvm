...
public:
    ...
    void retranslateUi(QDialog *CaptureInterfacesDialog)
    {
        ...
        ___qtreewidgetitem->setText(7, QCoreApplication::translate("CaptureInterfacesDialog", "Capture Filter", nullptr));
        ___qtreewidgetitem->setText(6, QCoreApplication::translate("CaptureInterfacesDialog", "Monitor Mode", nullptr));
        ___qtreewidgetitem->setText(5, QCoreApplication::translate("CaptureInterfacesDialog", "Buffer (MB)", nullptr));
        ___qtreewidgetitem->setText(4, QCoreApplication::translate("CaptureInterfacesDialog", "Snaplen (B)", nullptr));
        ___qtreewidgetitem->setText(3, QCoreApplication::translate("CaptureInterfacesDialog", "Promiscuous", nullptr));
        ___qtreewidgetitem->setText(2, QCoreApplication::translate("CaptureInterfacesDialog", "Link-layer Header", nullptr));
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("CaptureInterfacesDialog", "Traffic", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("CaptureInterfacesDialog", "Interface", nullptr));
#if QT_CONFIG(tooltip)
        capturePromModeCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>You probably want to enable this. Usually a network card will only capture the traffic sent to its own network address. If you want to capture all traffic that the network card can &quot;see&quot;, mark this option. See the FAQ for some more details of capturing packets from a switched network.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        capturePromModeCheckBox->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Enable promiscuous mode on all interfaces", nullptr));
#if QT_CONFIG(tooltip)
        manageButton->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Show and hide interfaces, add comments, and manage pipes and remote interfaces.", nullptr));
#endif // QT_CONFIG(tooltip)
        manageButton->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Manage Interfaces\342\200\246", nullptr));
        label_4->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Capture filter for selected interfaces:", nullptr));
        compileBPF->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Compile BPFs", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(inputTab), QCoreApplication::translate("CaptureInterfacesDialog", "Input", nullptr));
#if QT_CONFIG(tooltip)
        gbCaptureToFile->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Enter the file name to which captured data will be written. By default, a temporary file will be used.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        gbCaptureToFile->setTitle(QCoreApplication::translate("CaptureInterfacesDialog", "Capture to a permanent file", nullptr));
        browseButton->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Browse\342\200\246", nullptr));
        label_2->setText(QCoreApplication::translate("CaptureInterfacesDialog", "File:", nullptr));
        label->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Output format:", nullptr));
        rbPcapng->setText(QCoreApplication::translate("CaptureInterfacesDialog", "pcapng", nullptr));
        rbPcap->setText(QCoreApplication::translate("CaptureInterfacesDialog", "pcap", nullptr));
#if QT_CONFIG(tooltip)
        gbNewFileAuto->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Instead of using a single capture file, multiple files will be created.</p><p>The generated file names will contain an incrementing number and the start time of the capture.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        gbNewFileAuto->setTitle(QCoreApplication::translate("CaptureInterfacesDialog", "Create a new file automatically after\342\200\246", nullptr));
        MBCheckBox->setText(QString());
        SecsCheckBox->setText(QString());
#if QT_CONFIG(tooltip)
        SecsSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "If the selected file size is exceeded, capturing switches to the next file.\n"
"PLEASE NOTE: One option MUST be selected.", nullptr));
#endif // QT_CONFIG(tooltip)
        SecsComboBox->setItemText(0, QCoreApplication::translate("CaptureInterfacesDialog", "seconds", nullptr));
        SecsComboBox->setItemText(1, QCoreApplication::translate("CaptureInterfacesDialog", "minutes", nullptr));
        SecsComboBox->setItemText(2, QCoreApplication::translate("CaptureInterfacesDialog", "hours", nullptr));

#if QT_CONFIG(tooltip)
        SecsComboBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "If the selected file size is exceeded, capturing switches to the next file.\n"
"PLEASE NOTE: One option MUST be selected.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        MBSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>If the selected file size is exceeded, capturing switches to the next file.</p><p>PLEASE NOTE: One option MUST be selected.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        MBComboBox->setItemText(0, QCoreApplication::translate("CaptureInterfacesDialog", "kilobytes", nullptr));
        MBComboBox->setItemText(1, QCoreApplication::translate("CaptureInterfacesDialog", "megabytes", nullptr));
        MBComboBox->setItemText(2, QCoreApplication::translate("CaptureInterfacesDialog", "gigabytes", nullptr));

#if QT_CONFIG(tooltip)
        MBComboBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "If the selected file size is exceeded, capturing switches to the next file.\n"
"PLEASE NOTE: One option MUST be selected.", nullptr));
#endif // QT_CONFIG(tooltip)
        PktCheckBox->setText(QString());
#if QT_CONFIG(tooltip)
        PktSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Switch to the next file after the specified number of packets have been captured.", nullptr));
#endif // QT_CONFIG(tooltip)
        PktLabel->setText(QCoreApplication::translate("CaptureInterfacesDialog", "packets", nullptr));
#if QT_CONFIG(tooltip)
        RbCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>After capturing has switched to the next file and the given number of files has exceeded, the oldest file will be removed.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        RbCheckBox->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Use a ring buffer with ", nullptr));
        label_3->setText(QCoreApplication::translate("CaptureInterfacesDialog", "files", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(outputTab), QCoreApplication::translate("CaptureInterfacesDialog", "Output", nullptr));
        groupBox->setTitle(QCoreApplication::translate("CaptureInterfacesDialog", "Display Options", nullptr));
#if QT_CONFIG(tooltip)
        cbUpdatePacketsRT->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Using this option will show the captured packets immediately on the main screen. Please note: this will slow down capturing, so increased packet drops might appear.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        cbUpdatePacketsRT->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Update list of packets in real-time", nullptr));
#if QT_CONFIG(tooltip)
        cbAutoScroll->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>This will scroll the &quot;Packet List&quot; automatically to the latest captured packet, when the &quot;Update list of packets in real-time&quot; option is used.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        cbAutoScroll->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Automatically scroll during live capture", nullptr));
#if QT_CONFIG(tooltip)
        cbExtraCaptureInfo->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Show the capture info dialog while capturing.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        cbExtraCaptureInfo->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Show capture information during live capture", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("CaptureInterfacesDialog", "Name Resolution", nullptr));
#if QT_CONFIG(tooltip)
        cbResolveMacAddresses->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Perform MAC layer name resolution while capturing.", nullptr));
#endif // QT_CONFIG(tooltip)
        cbResolveMacAddresses->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Resolve MAC Addresses", nullptr));
#if QT_CONFIG(tooltip)
        cbResolveNetworkNames->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Perform network layer name resolution while capturing.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        cbResolveNetworkNames->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Resolve network names", nullptr));
#if QT_CONFIG(tooltip)
        cbResolveTransportNames->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Perform transport layer name resolution while capturing.", nullptr));
#endif // QT_CONFIG(tooltip)
        cbResolveTransportNames->setText(QCoreApplication::translate("CaptureInterfacesDialog", "Resolve transport names", nullptr));
        gbStopCaptureAuto->setTitle(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capture automatically after\342\200\246", nullptr));
#if QT_CONFIG(tooltip)
        stopPktSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified number of packets have been captured.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        stopMBSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified amount of data has been captured.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        stopMBCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Stop capturing after the specified amount of data has been captured.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        stopMBCheckBox->setText(QString());
        label_7->setText(QCoreApplication::translate("CaptureInterfacesDialog", "packets", nullptr));
#if QT_CONFIG(tooltip)
        stopSecsCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified amount of time has passed.", nullptr));
#endif // QT_CONFIG(tooltip)
        stopSecsCheckBox->setText(QString());
        stopSecsComboBox->setItemText(0, QCoreApplication::translate("CaptureInterfacesDialog", "seconds", nullptr));
        stopSecsComboBox->setItemText(1, QCoreApplication::translate("CaptureInterfacesDialog", "minutes", nullptr));
        stopSecsComboBox->setItemText(2, QCoreApplication::translate("CaptureInterfacesDialog", "hours", nullptr));

#if QT_CONFIG(tooltip)
        stopSecsComboBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified amount of time has passed.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        stopPktCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Stop capturing after the specified number of packets have been captured.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        stopPktCheckBox->setText(QString());
        stopMBComboBox->setItemText(0, QCoreApplication::translate("CaptureInterfacesDialog", "kilobytes", nullptr));
        stopMBComboBox->setItemText(1, QCoreApplication::translate("CaptureInterfacesDialog", "megabytes", nullptr));
        stopMBComboBox->setItemText(2, QCoreApplication::translate("CaptureInterfacesDialog", "gigabytes", nullptr));

#if QT_CONFIG(tooltip)
        stopMBComboBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified amount of data has been captured.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        stopSecsSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified amount of time has passed.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        stopFilesSpinBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "Stop capturing after the specified number of packets have been captured.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_8->setText(QCoreApplication::translate("CaptureInterfacesDialog", "files", nullptr));
#if QT_CONFIG(tooltip)
        stopFilesCheckBox->setToolTip(QCoreApplication::translate("CaptureInterfacesDialog", "<html><head/><body><p>Stop capturing after the specified number of files have been created.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        stopFilesCheckBox->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(optionsTab), QCoreApplication::translate("CaptureInterfacesDialog", "Options", nullptr));
        (void)CaptureInterfacesDialog;
    } // retranslateUi
